...
//                
                $sql = "SELECT * FROM sale_orders_detail WHERE salod_quarlity >= 2 GROUP BY salod_product_id ORDER BY salod_id DESC";
                          ...
                          <?php 
                                ...
                                if($result){
                                    ...
                                    foreach($result as $value){
                                       $userStat = $pdo -> prepare("SELECT * FROM products WHERE pro_id=".$value['salod_product_id']); 
                                       $userStat -> execute();
                                       $userResult = $userStat -> fetchAll();
                                ?>
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td><?php echo escape($userResult[0]['pro_name']) ?></td>
