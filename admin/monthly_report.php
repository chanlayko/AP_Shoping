  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Monthly Reprot</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <?php 
                ...
                $toMonth = date("Y-m-d",strtotime($curDate . '-1 month'));
                
                $sql = "SELECT * FROM sale_orders WHERE sal_order_date<:form_date AND sal_order_date>=:to_month ORDER BY sal_id DESC";
                $pdostat = $pdo -> prepare($sql);
                $pdostat -> execute(
                    array (':form_date'=>$fromDate,':to_month'=>$toMonth)    
                );
