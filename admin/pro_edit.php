<?php 
    ...
    $edStat = $pdo -> prepare("SELECT * FROM products WHERE pro_id=".$_GET['id']);
    $edStat -> execute();
    $edResult = $edStat -> fetchAll();
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                  <form action="" method="post" enctype="multipart/form-data">
                   ...
                   <input type="hidden" name="id" value="<?php echo escape($edResult[0]['pro_id']); ?>">
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" class="form-control" id="name" name="name" value="<?php echo escape($edResult[0]['pro_name']) ?>">
                        <p style="color:red"><?php echo empty($nameError) ? '' : $nameError; ?></p>
                    </div>
                    <div class="form-group">
                        <label for="desc">Description</label>
                        <textarea name="desc" class="form-control" id="desc" cols="20" rows="5" value=""><?php echo escape($edResult[0]['pro_description']) ?></textarea>
                        ...
                        <select name="cat" id="cat" class="form-control">
                            ...
                            <?php 
                                ...
                                foreach($catResult as $value){
                                    if($value['id'] == $edResult[0]['pro_category_id']){
                            ?>
                               <option value="<?php echo escape($value['id']) ?>" selected><?php echo escape($value['cat_name']) ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="qut" name="qut" value="<?php echo escape($edResult[0]['pro_quarlity']) ?>">
                        <p style="color:red"><?php echo empty($qutError) ? '' : $qutError; ?></p>
                    </div>
                    <div class="form-group">
                        <label for="price">Price</label>
                        <input type="number" class="form-control" id="price" name="price" value="<?php echo escape($edResult[0]['pro_price']) ?>">
                        <p style="color:red"><?php echo empty($priceError) ? '' : $priceError; ?></p>
                    </div>
                    <div class="form-group">
                       <label for="image">Image</label><br>
                        <input type="file" name="image" id="image">
                        <img src="images/<?php echo escape($edResult[0]['pro_image']) ?>" width="150px" alt="">
