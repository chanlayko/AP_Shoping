            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                   <div class="form-group">
                       <a href="user_add.php"><input type="submit" value="Add New User" class="btn btn-success"></a>
                   </div>
                   <div class="form-group">
                                ...
                                ?>
                                      <tr>
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td style="width: 50px"><a href="user_edit.php?id=<?php echo $value['id']; ?>"><input type="submit" value="Edit" class="btn btn-primary text-center"></a></td>
                                        <td style="width: 50px"><a href="user_delete.php?id=<?php echo $value['id']; ?>"><input type="submit" value="Delete" class="btn btn-primary text-center" onclick="return confirm('Are you sure you want to delete this item')"></a></td>
