        ...
        ?>		
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
						...
						<h3><?php echo escape($value['pro_name']) ?></h3>
						...
						<ul class="list">
                            ...
                            ?>
							<li><a class="active" href="categories.php?id=<?php echo escape($catResult['id']) ?>"><span>Category </span>: <?php echo escape($catResult['cat_name']) ?></a></li>
